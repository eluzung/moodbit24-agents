...
class OpenAISQL:
        ...
        try:
            response = self.client.chat.completions.create(
                ...
                messages=[
                    ...
                    Example:
                    User question: SELECT * FROM products WHERE stock_quantity LIKE 'A%' AND name > 50;
                    SQL query: SELECT * FROM products WHERE stock_quantity > 50 AND name LIKE 'A%';
    ...
    def query_and_process(self, user_question: str):
        ...
        print(f"Time taken to generate SQL query: {end_time} seconds")
        if not sql_query:
